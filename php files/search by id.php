            ...
            <div class="col-md-12">
                                <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM project_1 WHERE CONCAT(id) LIKE '%$filtervalues%' ";
                                        ...
                                        if(mysqli_num_rows($query_run) > 0)
                                        {
                                            ...
                                            <br>
                                                   ...
                                                   <a class ="link" href="http://localhost/MY PROJECT/REGISTRATION FORM/new/studentdetails.php"  > <h3 class="link"  >View More Details</h3></a>
                                                </div>
